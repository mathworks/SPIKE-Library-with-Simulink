...
static STK_T _kernel_stack_SPIKE_CYC_TASK[COUNT_STK_T(STACK_SIZE)];
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (intptr_t)(0), (TASK)(Main), INT_PRIORITY(MAIN_PRIORITY), {	(void *)(_kernel_stack_MAIN_TASK), 	((void *)((char *)(_kernel_stack_MAIN_TASK) + (ROUND_STK_T(STACK_SIZE)))), }, },
	{ (TA_NULL), (intptr_t)(0), (TASK)(spike_cyc_task_high), INT_PRIORITY(MAIN_PRIORITY - 2), {	(void *)(_kernel_stack_SPIKE_CYC_TASK), 	((void *)((char *)(_kernel_stack_SPIKE_CYC_TASK) + (ROUND_STK_T(STACK_SIZE)))), }, }
};

TCB _kernel_tcb_table[TNUM_TSKID];

const ID _kernel_torder_table[TNUM_TSKID] = { 
	PYBRICKS_TASK, TSKID_tTask_LogTask_Task, MAIN_TASK, SPIKE_CYC_TASK
};
...
static void
_kernel_nfyhdr_CYC1(intptr_t exinf)
{
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	...
	{ (TA_STA), (intptr_t)(SPIKE_CYC_TASK), _kernel_nfyhdr_CYC1, (4U * 1000U), (0U) }
};
...
const INTINIB _kernel_intinib_table[TNUM_CFG_INTNO] = {
	...
	{ (INTNO_UART9), (INTATR_UART9), (INTPRI_UART9) },
