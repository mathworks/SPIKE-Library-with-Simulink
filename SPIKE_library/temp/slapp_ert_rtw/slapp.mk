###########################################################################
## Makefile generated for component 'slapp'. 
## 
## Makefile     : slapp.mk
## Generated on : Wed Jul 09 12:23:12 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/slapp.exe
...
START_DIR                 = C:/class/test/SPIKE_library_20250709/SPIKE_library/temp
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = slapp_comp.rsp
CMD_FILE                  = slapp.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/slapp.exe
...
DEFINES_STANDARD = -DMODEL=slapp -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slapp_ert_rtw/slapp.c

MAIN_SRC = $(START_DIR)/slapp_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/slapp_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slapp_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slapp_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slapp_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slapp_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.obj : $(START_DIR)/slapp_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


slapp.obj : $(START_DIR)/slapp_ert_rtw/slapp.c
	$(CC) $(CFLAGS) -o "$@" "$<"
