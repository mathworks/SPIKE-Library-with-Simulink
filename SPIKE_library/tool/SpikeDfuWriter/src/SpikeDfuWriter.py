# Written by Afrel Co.,Ltd. 2023/3/1
...
def get_dfu_devices(*args, **kwargs):
    ...
    return list(usb.core.find(backend=backend, *args, find_all=True, custom_match=FilterDFU(), **kwargs))
...
def main():
    kwargs = {}
    kwargs["idVendor"] = int('0x0694',0)
    kwargs["idProduct"] = int('0x0008',0)
